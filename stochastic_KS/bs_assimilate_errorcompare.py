...
os.makedirs('../../DA_KS/BS_checkpoint_files/ensembles_assimilated/', exist_ok=True)
...
#     outfile.append(VTKFile(f"../../DA_KS/BS_2000/{ensemble_idx}_output.pvd", comm=jtfilter.subcommunicators.comm))
...
for k in range(N_obs):
    ...
    jtfilter.assimilation_step(yVOM, log_likelihood,  ess_tol=-9000.8,  diagnostics=diagnostics)
...
if fd.COMM_WORLD.rank == 0:
    np.save("../../DA_KS/2000_bs_ensemble.npy", y_e)