...
if COMM_WORLD.rank == 0:
    ...
    print(psi_e.shape)
    if not nudging:
        np.save("../../DA_Results/2DEuler_mixed/next_tempjitt_assimilated_Vorticity_ensemble.npy", psi_e)
    if nudging:
        np.save("../../DA_Results/2DEuler_mixed/next_nudge_assimilated_Vorticity_ensemble.npy", psi_e)


# # finally to store ensembles for further nudging finale
...
erank = jtfilter.ensemble_rank
filename = f"../../DA_Results/2DEuler_mixed/checkpoint_files/ensemble_100_nudge{erank}.h5"
