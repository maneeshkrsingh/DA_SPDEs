...
truth = File("../../DA_Results/2DEuler/paraview/truth.pvd")
...
np.save("../../DA_Results/2DEuler/u_true_data.npy", u_true_all)
np.save("../../DA_Results/2DEuler/u_obs_data.npy", u_obs_all)
